...
namespace Medical.Infrastructure.Redis
{
    ...
    public class RedisHashService:RedisBase
    {
        ...
        {
            return await Task.Run(() => base.IClient.SetEntryInHash(hashid, key, value));
        }
        ...
        {
            return  await Task.Run(() => base.IClient.GetValueFromHash(hashid, key));
        }
        ...
        /// <summary>
        /// 删除hashid数据集中的多个key数据
        /// </summary>
        /// <param name="hashid"></param>
        /// <returns></returns>
        public async Task<bool> RemoveEntryAsync(string hashid)
        {
            return await Task.Run(() => base.IClient.Remove(hashid));
        }
